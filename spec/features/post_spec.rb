...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do 
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: 'nonauth@user.com', password: 'asdfasdf', password_confirmation: 'asdfasdf')
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: "asdf", user_id: delete_user.id, overtime_request: 4.7)
      visit posts_path
